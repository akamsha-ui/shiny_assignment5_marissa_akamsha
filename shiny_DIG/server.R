...
#Analysis page###############################################################################################################
  ...
  output$usergraph <- renderText({
    HTML("<p>A scatter plot is ideal for showing the relationship between two continuous variables.<p> 
         ...
         allows you to filter the data more effectively and customize the graph output (user will need to select atleast one box
         for each discrete variable to generate a plot) according to your specific needs.<p>
